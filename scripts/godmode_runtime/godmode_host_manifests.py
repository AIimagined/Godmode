...
def build_antigravity_fragment() -> dict:
    ...
    return {
        "_note": (
            ...
            "path - this machine's path: after a clone elsewhere, run the "
            "wire again there, and hooks status names a dead path. stdout "
            "for PreToolUse must be a single JSON object "
